...
/**
 * gsen Request class that encasulates the request of a call.
 * Clients to not create this. gsen does it for us.
 */
class Request {
  /**
   * Creates a gsen Request instance
   * @param {Object} call the grpc call instance
   * @param {String} type the call type. one of `gsen-call-types` enums.
   */
...
/**
 * The call's type. One of `gsen-call-types` enums.
 * @member {String} type
 * @memberof Request#
 * @example
