...
/**
 * @name Context
 * @summary Represents a gsen call context
 * @class
 * @global
 * @classdesc Represents the application and call context. Clients to not create this. gsen does it for us.
 * @example
...
/**
 * The call's gsen Request object.
 * @member {Object} request
 * @memberof Context#
 */

/**
 * The call's gsen Response object.
